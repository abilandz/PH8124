# Homework 2: User-made executables as Linux/Bash commands
...
Then, compile the above code in order to create an executable (or binary) file. For instance, you can compile C/C++ code by using the freely available **gcc** compiler, with the following syntax:
