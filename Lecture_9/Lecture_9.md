...
1. [Command history search](Lecture_9.md#command_history_search)
2. [Searching for files and directories: **find**](Lecture_9.md#find)
3. [Online monitoring: **tail -f**](Lecture_9.md#tail)
4. [Timing: **timeout** and **time**](Lecture_9.md#timing)
5. [Counting: **wc**](Lecture_9.md#counting)
6. [Building programmatically command input: **eval**](Lecture_9.md#eval)
